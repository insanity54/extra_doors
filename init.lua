--------------------------------------------------------
-- Minetest :: Extro Doors (extro_doors)
--
...
minetest.register_craftitem("extro_doors:steel_rod", {
        description = "Steel Rod",
        inventory_image = "doors_steel_rod.png",
})

minetest.register_craft( {
        output = "extro_doors:steel_rod 4",
        recipe = {
                { "default:steel_ingot" },
        }
} )
...
doors.register( "door_barn2", {
	...
	recipe = {
		{ "group:wood", "group:wood", "group:wood" },
		{ "extro_doors:steel_rod", "extro_doors:steel_rod", "extro_doors:steel_rod" },
		{ "group:wood", "group:wood", "group:wood" },
	}
} )
...
doors.register( "door_castle2", {
	...
	groups = { choppy = 2, oddly_breakable_by_hand = 2, flammable = 2 },
	recipe = {
		{ "extro_doors:steel_rod", "group:wood", "group:wood" },
		{ "", "group:wood", "group:wood" },
		{ "extro_doors:steel_rod", "group:wood", "group:wood" },
	}
} )
...
doors.register("door_dungeon1", {
	...
	recipe = {
		{ "default:steel_ingot", "extro_doors:steel_rod", "default:steel_ingot" },
		{ "extro_doors:steel_rod", "extro_doors:steel_rod", "extro_doors:steel_rod" },
		{ "default:steel_ingot", "extro_doors:steel_rod", "default:steel_ingot" },
	}
} )
...
doors.register( "door_steelpanel1", {
	...
	sound_close = "doors_steel_door_close",
	recipe = {
		{ "default:steel_ingot", "default:steel_ingot", "extro_doors:steel_rod" },
		{ "default:steel_ingot", "default:steel_ingot", "extro_doors:steel_rod" },
		{ "default:steel_ingot", "default:steel_ingot", "extro_doors:steel_rod" },
	}
} )
...
doors.register( "door_steelglass1", {
	...
	sound_close = "doors_steel_door_close",
	recipe = {
		{ "default:glass", "default:glass", "extro_doors:steel_rod" },
...
minetest.register_craft( {
	type = "fuel",
	recipe = "extro_doors:door_barn1",
	burntime = 14,
} )

minetest.register_craft( {
	type = "fuel",
	recipe = "extro_doors:door_barn2",
	burntime = 16,
} )

minetest.register_craft( {
	type = "fuel",
	recipe = "extro_doors:door_castle1",
	burntime = 8,
} )

minetest.register_craft( {
	type = "fuel",
	recipe = "extro_doors:door_castle2",
	burntime = 12,
} )
